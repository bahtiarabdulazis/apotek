        ...
        <tbody>
            ...
            @foreach ($medicines as $item)
                <tr>
                    <td>{{$no++}}</td>
                    <td>{{$item['name']}}</td>
                    <td style="{{ $item['stock'] <= 3 ? 'background: red; color: white;' : ($item['stock'] > 10 ? 'background: green; color: white;' : ($item['stock'] > 5 ? 'background: yellow; color: black;' : 'background: none; color: black;'))}}">
                        {{ $item['stock'] }}
                    </td>
